...
class SensorSledUI:
    def __init__(self, master, serial_port):
        ...
        self.sleep_button = ttk.Button(master, text="Sleep Mode (wakes up on read)", command=self.sleep_mode)
        self.sleep_button.pack()
        self.reset_button = ttk.Button(master, text="Reset Sensor Sled", command=lambda: serial_port.write(b'RESET\n'))
        self.reset_button.pack()
        self.write_to_csv_button = ttk.Button(master, text="Write to CSV", command=self.write_to_csv)
